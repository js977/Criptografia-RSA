...
int main(int argc, char *argv[]) {
    ...
    if (argc < 3) {
        ...
        cout << "Utilização: ./testaMetodoEuclides <lista_primos> <nome_ficheiro_para_escrita>\n\n";
        cout << "Por exemplo: ./testaMetodoEuclides listaPrimos1.lstp resultadosME1.csv\n\n";
    ...
    ficheiroCSV <<  " ; " << " Método da Euclides " << " ; " <<  " ; " << endl;
