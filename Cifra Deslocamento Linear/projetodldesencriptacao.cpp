...
int main(int argc, char *argv[]){
  ...
  menscifrada = argv[2];
	...
	std::fstream fx(argv[1], std::ios::in); // Abrir arquivo de entrada para leitura
    ...
    std::fstream fd(argv[2], std::ios::out); // Abrir arquivo de saída para escrita
    ...
    desencriptar(valora, valorb,fx, fd);
